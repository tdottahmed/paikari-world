...
import { CartItem, DeliveryCharge } from "@/types";
import {
    User,
    Phone,
    MapPin,
...
export default function Checkout({ cart, deliveryCharges }: CheckoutProps) {
    ...
    const total =
        subtotal + (selectedDelivery ? Number(selectedDelivery.cost) : 0);
